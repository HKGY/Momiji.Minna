...
if(!Object.assign)Object.assign=function(){var a = arguments,i=1;for(;i<a.length;i++)for(var k in a[i])a[0][k] = a[i][k];return a[0]}
...
setPicQuty : function(){
var as = this.appSetting,s=this.bits,b=this.bit,o=0
//autoPicM/autoPic:缩略优先 lessPic:阈值更低
if(b & (s.size10|s.size7|s.size4)){
	if(as.NetWorkStatus != undefined){
		if(as.NetWorkStatus == 'Wifi')
			o |= s.autoPicM | (as.wifiShowImg ? 0 : s.noPic)
		else{
